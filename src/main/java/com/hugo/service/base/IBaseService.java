...
public interface IBaseService {
     ...
     * @return
     */
    Map<String, Object> queryPageListByHql(final String hql, final List<?> paramList, final int page, final int rows);
     ...
     * @return
     */
    Map<String, Object> queryPageListBySql(final String sql, final List<?> paramList, final int page, final int rows);
     ...
     * @return
     */
    Map<String, Object> queryPageListByHql(final String hql, final Map<String, Object> pMap, final int page, final int rows);
     ...
     * @return
     */
    Map<String, Object> queryPageListBySql(final String sql, final Map<String, Object> pMap, final int page, final int rows);
     ...
     * @return
     */
    Map<String, Object> queryPageListBySql(final String sql, final String countSql, final Map<String, Object> pMap, final Map<String, Object> countMap);
     ...
     * @return
     */
    Map<String, Object> queryPageListBySql(final String sql, final String countSql, final List<?> paramList);
